...
const { login, signup,follow,onBoard,unfollow,getById,search,getfollow,getmentors,getmentorsByType,logout,isloggedin } = require('../controllers/users');
...
userRoutes.get('/isloggedin', isloggedin);
